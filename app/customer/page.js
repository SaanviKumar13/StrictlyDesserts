...
<section className="bg-pink-50 py-16">
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
    <h2 className="text-3xl font-extrabold text-pink-800 mb-12">Browse by Category</h2>
    <div className="flex justify-center gap-8">
      <Link href="/customer/order?category=cakes" className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition duration-300 w-full max-w-xs">
        <div className="flex flex-col items-center">
          <Cake className="h-12 w-12 text-pink-600 mb-4" />
          <h3 className="text-xl font-semibold text-pink-800">Cakes</h3>
          <p className="font-medium text-gray-700 text-center mt-2">
            Birthday cakes, wedding cakes, and more
          </p>
        </div>
      </Link>

      <Link href="/customer/order?category=cookies" className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition duration-300 w-full max-w-xs">
        <div className="flex flex-col items-center">
      ...
      <Link href="/customer/order?category=special" className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition duration-300 w-full max-w-xs">
        <div className="flex flex-col items-center">
      ...
      <footer className="w-full bg-pink-200 mt-12">
